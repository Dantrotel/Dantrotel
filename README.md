...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>🎓 AcTitUBB</h3>
      <p>Plataforma web full-stack para coordinar las actividades del proceso de titulación universitaria en la UBB. Diseñada para docentes, alumnos y coordinadores.</p>
      <p>
    ...
    <td width="50%" valign="top">
      ...
      <p>Aplicación móvil para búsqueda y listado de propiedades con mapas integrados, desarrollada durante práctica profesional en Agartha Marketing Agency.</p>
      <p>
